...
export class ERC20Token extends ethereum.SmartContract {
  ...
  ERR_INVALID_ZERO_VALUE(): BigInt {
    let result = super.call(
      "ERR_INVALID_ZERO_VALUE",
      "ERR_INVALID_ZERO_VALUE():(uint256)",
      []
    );
  ...
  try_ERR_INVALID_ZERO_VALUE(): ethereum.CallResult<BigInt> {
  ...
  ERR_NO_ERROR(): BigInt {
    let result = super.call("ERR_NO_ERROR", "ERR_NO_ERROR():(uint256)", []);

    return result[0].toBigInt();
  }

  try_ERR_NO_ERROR(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("ERR_NO_ERROR", "ERR_NO_ERROR():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_withdraw(amount: BigInt): ethereum.CallResult<BigInt> {
